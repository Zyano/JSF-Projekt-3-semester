...
public class CategoryBean implements Serializable {
    ...
    /**
     * adds a message(news post) to the currently selected category. admin use
     * case?
     *
     * @param text
     * @param title
    ...
    /**
     * Sends the user to category.xhtml. showing all messages from the selected
     * category.
     *
     * @param cat
     * @return category
    ...
    /**
     * Should be changed to return the currently selected Category and the
     * amount of submessages.
     *
     * @return
     */
    ...
    public String deleteMessage() {
        String s = "category";
        category.removeMessage(currentlySelectedMessage);
        return s;
    }
